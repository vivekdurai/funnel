...
def participant_badge(profile, space, participant):
    return render_template('premium-badge.html', badges=participant_badge_data([participant], space))
...
def event_badges(profile, space, event):
    ...
    if 'premium' in event.name:
        return render_template('premium-badge.html', badges=participant_badge_data(participants, space))
    else:
